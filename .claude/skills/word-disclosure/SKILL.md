...
本入口只保留执行骨架；输出格式、来源、分析、范文索引和自检都回到 reference。诠释理论以海德格尔的中后期思想为内部锚，帮助分析避开主体—客体分离，不把词语机械理解为主体的属性、动作的附加成分或容器中的状态，不静态化理解空间、时间，不信任传统语法学的对单词成分的划界。只锚定分析方向：除非词语或来源本身直接涉及海德格尔，正文不点名海德格尔，也不用哲学的专业术语。
